...
void traversal(node* root){
    ...
    //we are printing all three type of traversal togeter
    cout<<(to_string(root->data)+" in preorder ")<<endl; //write this line only for print if u want only preorder
    traversal(root->left);
    cout<<(to_string(root->data)+" in inorder ")<<endl;  //write this line only for print if u want only inorder
    traversal(root->right);
    cout<<(to_string(root->data)+" in postorder ")<<endl; //write this line only for print if u want only postorder
}
int main()
{
